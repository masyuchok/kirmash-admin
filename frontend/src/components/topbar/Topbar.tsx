...
const btnDanger =
  `${btnBase} border border-red-200 bg-red-50 text-red-700 shadow-sm hover:bg-red-100 focus-visible:outline-red-300`;
...
const Topbar = () => {
  ...
  const resolveButtonClass = (variant: 'primary' | 'secondary' | 'danger', iconOnly?: boolean) =>
